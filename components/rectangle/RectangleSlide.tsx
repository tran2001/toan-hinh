...
import SmallSquare from "../square/SmallSquare";
  ...
  return (
    <div className="tw-w-full tw-h-full tw-pt-[50px]">
      ...
      <div className=" tw-flex tw-justify-center tw-items-center tw-h-full tw-relative">
        <div
          className="tw-w-[540px] tw-h-[400px] tw-relative tw-duration-300"
          id="square"
        >
          <div className="tw-w-[532px] tw-h-[396px] tw-grid tw-grid-cols-4 tw-gap-1 tw-absolute tw-top-1 tw-left-1 tw-z-50">
          ...
          ></div>
          <div
            className="tw-w-[540px] tw-h-1 tw-bg-[#000053] tw-cursor-pointer"
            id="edge-cd"
          ></div>
          <div
            className="tw-w-[540px] tw-h-1 tw-bg-[#000053] tw-cursor-pointer tw-absolute tw-top-0 tw-duration-300"
            id="edge-ab"
          ></div>
          <div
